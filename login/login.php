...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <form action="<?php echo $_SERVER["REQUEST_URI"]; ?>" method="post">
      ...
      <div class="form-group has-feedback">
        <input type="password" name="password" class="form-control" placeholder="Password" required maxlenght="20">
    ...
    <a href="register.php" class="text-center">Non hai un account? Registrati</a>
